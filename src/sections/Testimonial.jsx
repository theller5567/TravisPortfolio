  ...
  return (
    <div id="testimonials" classNam="items-start c-space mt-25 md:mt-35">
      ...
      <div className="relative flex w-full mt-12 flex-col items-center justify-center overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-linear-to-r from-primary"></div>
        <div className="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-linear-to-l from-primary"></div>
      </div>
    </div>
  )
}
