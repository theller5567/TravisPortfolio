export const myProjects = [
  {
    id: 1,
    title: "Synapse App - React",
    description:
      "Synapse is an AI-powered media management platform that centralizes images, videos, documents, and audio into a single, intelligent library. It replaces fragile folder structures with flexible metadata schemas, hierarchical tagging, and semantic search so teams can align their media catalog to real-world workflows and find the right asset by meaning instead of file names.",
    subDescription: [
      "AI-Enhanced Discovery: Uses AI to generate rich descriptions, auto-tags, and semantic embeddings so users can search for assets using natural language rather than rigid filters.",
      "Custom Media Types & Forms: Includes a Media Type Builder that lets admins define allowed formats, colors, and custom fields (text, numbers, dates, selects, URLs), automatically generating dynamic forms that enforce required metadata at upload time.",
      "Hierarchical Tagging & Insights: Supports structured tag hierarchies, usage counts, and basic analytics so teams can see which tags, campaigns, or content types are most common, which are underused, and how assets are distributed across the library.",
      "Advanced Video Management: Integrates with Cloudinary to extract technical metadata, support adaptive streaming, and provide a frame-accurate thumbnail selector so editors can choose the exact frame that best represents each video.",
      "Collaboration & Governance: Built with Convex, Better Auth, and role-based access control to support multi-user workflows, audit-friendly activity logs, notification hooks, and a clear separation between demo mode (no persistence) and production data.",
    ],
    href: "https://media-manager-app-frontend.vercel.app/",
    logo: "",
    ...
    tags: [
      ...
      },
      {
        id: 2,
        name: "Better Auth",
        path: "/assets/logos/betterauth.svg",
      },
      {
        id: 3,
        name: "Convex",
  ...
  },
  {
    ...
    subDescription: [
      "Built the marketing site with Next.js, React, TypeScript, and Tailwind CSS to showcase the AI-powered media management app and support conversions.",
  "Implemented the landing experience using Framer Motion and Lucide icons for animations and a polished, responsive layout.",
  "Designed hero, pricing, and CTA sections with prominent Start Free Trial and Watch Demo buttons to encourage signups and purchases.",
  "Added a pricing grid (Starter, Professional, Enterprise) and a bottom CTA to influence users to try or buy the app."
    ],
    href: "https://media-manager-site.vercel.app/",
    logo: "",
    image: "/assets/projects/synapsesite.png",
    tags: [
      {
        id: 1,
        name: "React",
  ...
  },
  {
    ...
    subDescription: [
      "Dynamic Question Fetching: Integrates with Open Trivia DB, using session tokens to avoid duplicate questions and gracefully handling empty-token and edge-case responses.",
      "Category & Difficulty Control: Lets players choose categories and difficulty levels on the Home screen, then builds each quiz round from matching questions in real time.",
      "Answer Feedback & Scoring: Enforces one active answer per question, highlights correct and incorrect choices after submission, and provides a clear score summary at the end.",
      "Modern UI & Animations: Built with React, Tailwind CSS, and motion-based animations to deliver smooth transitions, responsive layouts, and satisfying button/hover states.",
      "Resilient UX & Caching: Uses localStorage to cache questions and session tokens, includes defensive error handling, and is wired up with React Router for SPA-style navigation and Netlify-friendly deploys.",
    ],
    href: "https://quiztrivia-adventure.netlify.app/",
    logo: "",
    image: "/assets/projects/quiztrivia.jpg",
    tags: [
      {
        id: 1,
        name: "JavaScript",
